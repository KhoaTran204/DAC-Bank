...
const sendEmail = (req, res) => {
            ...
            <table width="600" style="background:#fff;border-radius:8px;font-family:Arial">
              ...
              <tr>
                <td align="center" style="padding:20px">
                  <img src="cid:dacbanklogo" width="140" alt="Nova Bank" />
                </td>
              </tr>
  ...
  const mailOption = {
    ...
    attachments: [
      {
        filename: "novabanklogo.png",
        path: path.join(__dirname, "../public/novabanklogo.png"),
        cid: "novabanklogo", // 👈 trùng với src="cid:novabanklogo"
      },
    ],
  };
