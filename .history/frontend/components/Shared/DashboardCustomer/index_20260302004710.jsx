        ...
        {compare && (
          <Card bordered={false} className="rounded-2xl shadow-md">
            <div className="font-semibold text-gray-700">
              ...
              <span
                className={
                  compare.percent >= 0 ? "text-green-600" : "text-red-600"
                }
              >
                {compare.percent}%
              </span>
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData}>
                ...
                <Line dataKey="credit" stroke="#16A34A" strokeWidth={3} />
                <Line dataKey="debit" stroke="#DC2626" strokeWidth={3} />
                <Line dataKey="balance" stroke="#2563EB" strokeWidth={4} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </Card>
