  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {/* BAR 1 */}
        <Card className="md:col-span-1" title="Số tài khoản tạo mới theo ngày">
        ...
        {/* BAR 2 */}
        <Card className="md:col-span-1" title="Số giao dịch theo ngày">
          <ResponsiveContainer width="100%" height={280}>
        ...
        {/* PIE */}
        <Card className="md:col-span-1" title="Tổng tiền giao dịch">
          <ResponsiveContainer width="100%" height={280}>
            <PieChart>
              <Pie
                data={pieData}
