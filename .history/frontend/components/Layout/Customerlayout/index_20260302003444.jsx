  ...
  return (
    <Layout className="!min-h-screen">
      ...
      <Sider
        ...
        collapsed={collapsed}
        width={240}
        className="bg-[#0B1220] shadow-2xl"
      >
        <div className="h-16 flex items-center justify-center text-blue-400 font-bold text-lg tracking-wide border-b border-[#1E293B]">
      ...
      <Layout>
        ...
        {/* ================= FOOTER ================= */}
        <Footer className="text-center text-sm text-gray-500 bg-[#0F172A] border-t border-[#1E293B]">
